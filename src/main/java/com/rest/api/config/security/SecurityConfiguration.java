...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  @Override
  public void configure(WebSecurity web) throws Exception { //ignore check swagger resource
          ...
          http
              ...
              .and()
                  .authorizeRequests() // 다음 리퀘스트에 대한 사용권한 체크
                      ...
                      .antMatchers(HttpMethod.GET, "/exception/**", "hello/**").permitAll() // hellowworld로 시작하는 GET요청 리소스는 누구나 접근가능
